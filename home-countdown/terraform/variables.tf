...
variable "bucket_name" {
  description = "Existing S3 bucket where the home countdown app will be uploaded."
  type        = string
  default     = "happybirthdayjenna.co.uk"
}

variable "site_prefix" {
  description = "Path prefix for the home countdown app in the shared bucket."
  type        = string
  default     = "home-countdown"
