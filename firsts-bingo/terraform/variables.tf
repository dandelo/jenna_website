...
variable "bucket_name" {
  description = "Existing S3 bucket where the firsts bingo app will be uploaded."
  type        = string
  default     = "happybirthdayjenna.co.uk"
}

variable "site_prefix" {
  description = "Path prefix for the firsts bingo app in the shared bucket."
  type        = string
  default     = "firsts-bingo"
